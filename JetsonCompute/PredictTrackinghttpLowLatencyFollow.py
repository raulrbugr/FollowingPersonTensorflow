#Is needed Tensorflow and Tensorflow Obeject detection API to run this code
#If you have troubles to run this, put it into InstallationApiPWD/models/research/object_detection

import urllib
stream=urllib.urlopen('http://192.168.1.102:8080/?action=stream') #Server IP and port
import numpy as np
import os
    ...
    while True:
      ...
      if a !=- 1 and b != -1:
         ...
         if wordwanted in name:
          ...
          if(ycenter > 330):
           fout = open('/home/nvidia/Projects/SharedFile/sharedf.txt','w')
           fout.write('l') #turn camera left
           print "Left"
           fout.close()

          elif(ycenter < 270):
           fout = open('/home/nvidia/Projects/SharedFile/sharedf.txt','w')
           fout.write('r') #turn camera right
           print "Right"
           fout.close()

          #elif(ycenter >= 270 and ycenter <=330):
           #fout = open('/home/nvidia/Projects/SharedFile/sharedf.txt','w')
           #fout.write('m') #Step
           #fout.close()
